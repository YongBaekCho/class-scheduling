...
def create_df():
    ...
    data = [{'a:sp14':mean_lec_sp14,'b:fall14':mean_lec_fall14, 'c:sp15':mean_lec_sp15, 'd:fall15': mean_lec_fall15, 'e:sp16':mean_lec_sp16, 'f:fall16':mean_lec_fall16, 'g:sp17':mean_lec_sp17, 'h:fall17':mean_lec_fall17, 'i:sp18':mean_lec_sp18, 'j:fall18':mean_lec_fall18}]
...
def make_fig(df):
    ...
    ax.set_title("Lectures for semsesters", fontsize = 24)
